...
| `ADMIN_USER_IDS`                                            | Optional. Comma-separated user ids granted platform-admin access (Better Auth's `admin` plugin) — bootstraps the first admin, see `AGENTS.md`'s "Platform admin" section |
